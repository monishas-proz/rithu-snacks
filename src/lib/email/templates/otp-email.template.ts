export function getOtpEmailTemplate(otp: string): { subject: string; html: string; text: string } {
    ...
    <html>
      ...
      <body>
        <div class="container">
          ...
          <p class="info">This code expires in <strong>5 minutes</strong>.<br>If you did not request this code, no action is required.</p>
