...
import { useCategories, useDeleteCategory, useCreateCategory, useUpdateCategory } from "@/features/categories/hooks";
...
const mostPopular =
  categories.length > 0
    ? categories.reduce((prev, current) =>
        (current._count?.products || 0) >
        (prev._count?.products || 0)
          ? current
          : prev
      )
    : null;
